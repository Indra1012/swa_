...
export default function About() {
  ...
  const [pageData, setPageData] = useState({
    ...
    corePhilosophyQuote: '"We move past quick fixes to provide structured, practical wellbeing programs that create real, lasting changes in your environment."',
    corePhilosophyBullets: 'Performance is driven by inner stability, not external pressure.\nWellbeing is a skill that can be developed.\nTransformation happens through consistent experiential learning.\nEmotional awareness leads to better decisions and outcomes.',
  ...
  return (
    <div style={{ position: 'relative', overflow: 'hidden', minHeight: '100vh' }}>
      <main ref={pageRef} className="about-page" style={{ margin: 0, padding: 0, minHeight: '100vh', overflow: 'hidden' }}>
        ...
        <section style={{ background: 'transparent', padding: '10px 0 0px', margin: 0, marginTop: -30, position: 'relative', zIndex: 2 }}>
          <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 clamp(20px, 4vw, 40px)' }}>
            {/* Header */}
            <KineticWrap yStart={60} yEnd={-20} scaleStart={0.85} style={{ textAlign: 'center', marginBottom: '60px' }}>
              ...
              <span style={{ fontSize: '11px', color: 'var(--dark)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '4px', marginBottom: '24px', display: 'block' }}>
            ...
            {/* Vision / Mission / Philosophy Light Frosted Cards */}
            <div className="about-cards-grid">
              ...
              <div className="core-philosophy-card-wrapper">
                <ExpandableCard title={pageData.corePhilosophyTitle} delay={0.2}>
                  <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '24px', color: 'var(--dark)', fontStyle: 'italic', lineHeight: 1.4, marginBottom: '24px', marginTop: 0 }}>
                    {pageData.corePhilosophyQuote}
                  </p>
                  <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                    {(pageData.corePhilosophyBullets || '').split('\n').filter(Boolean).map((txt, i) => (
                      <li key={i} style={{ position: 'relative', paddingLeft: '24px', marginBottom: '16px', fontSize: '15px', color: 'var(--dark)', fontWeight: 500, lineHeight: 1.6 }}>
                        <div style={{ position: 'absolute', left: 0, top: '8px', width: '6px', height: '6px', borderRadius: '50%', background: 'var(--accent)' }} />
                        {txt.trim()}
                      </li>
        ...
        {/* Removed text */}
        <section style={{ background: 'transparent', padding: '40px 0 20px', margin: 0 }}>
          <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 clamp(20px, 4vw, 40px)' }}>
            <motion.div
              initial={{ opacity: 0 }}
        ...
        <section style={{ background: 'transparent', padding: '20px 0', margin: 0 }}>
