...
const SERVICES_DATA = [
  ...
  },
  {
    ...
    headline: 'Building Emotionally Strong & Focused Students',
  ...
  },
  {
    ...
    headline: 'Creating Healthier, More Resilient Communities',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 style={{
          fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(40px, 4.5vw, 64px)', 
          fontWeight: 400, color: 'var(--dark)', lineHeight: 1.1, letterSpacing: '-1px', marginBottom: '24px'
        }}>
          {data.headline}
        </h2>
        <p style={{
      ...
      <motion.div
        ...
        transition={{ duration: 1.3, ease: [0.16, 1, 0.3, 1] }}
        style={{
          width: '100%', height: '500px', borderRadius: '32px', overflow: 'hidden', position: 'relative',
          marginBottom: '80px', boxShadow: '0 30px 60px rgba(0,0,0,0.08)'
        }}
      >
        <motion.img 
      ...
      <div style={{
        display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '40px', marginBottom: '80px'
      }}>
        {/* Challenge Card */}
        <motion.div
          initial={{ opacity: 0, y: 40 }}
      ...
      <div style={{
        display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '40px', marginBottom: '80px',
        alignItems: 'start'
      }}>
...
export default function ServicesPage() {
  ...
  return (
    <main style={{ 
      position: 'relative',
      background: 'var(--bg)', 
      minHeight: '100vh', paddingTop: '160px', paddingBottom: '140px', overflow: 'hidden' 
    }}>
