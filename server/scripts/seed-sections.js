...
const TECHNIQUES = [
  { category: 'healing', title: 'Psychological Wellbeing', subtitle: 'Mind', image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=800&q=80', readMoreText: 'Helps individuals understand their thoughts, build resilience, and develop healthier mental patterns through Eastern & Western Psychology, CBT, Psychotherapy, Positive Psychology, and NLP.', order: 0 },
  ...
  { category: 'healing', title: 'Body & Somatic', subtitle: 'Wellbeing', image: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=800&q=80', readMoreText: 'Helps release stored stress, regulate the nervous system, and reconnect with the body through Somatic awareness, Body-mind therapies, Movement practices, Zumba and yoga.', order: 2 },
  ...
  { category: 'healing', title: 'Social & Community', subtitle: 'Wellbeing', image: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=800&q=80', readMoreText: 'Strengthens social bonds and builds supportive environments through Peer support circles, Group reflection, Communication exercises, and Community engagement.', order: 4 },
  { category: 'healing', title: 'Nature & Environmental', subtitle: 'Wellbeing', image: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=600&q=80', readMoreText: 'Encourages grounding, creativity, and emotional restoration through Nature-based therapy, Outdoor mindfulness, Sensory awareness, and Environmental reflection.', order: 5 },
]
...
const TESTIMONIALS = [
  ...
  { name: 'Edelweiss', rating: 5, quote: "What Began as Wellbeing Became a Cultural Shift", text: "We were looking for something fresh and meaningful. What we got was a complete transformation of how our organization thinks about wellbeing and happiness.", order: 1 },
  ...
  { name: 'Amazon', rating: 5, quote: "Wellbeing at Scale, Done Right", text: "Implementing SWA across thousands of employees was seamless, impactful, and deeply human. A remarkable achievement we are proud of.", order: 3 },
  ...
  { name: 'Blue Star', rating: 5, quote: "More Energy, More Joy, Every Day", text: "The wellbeing festivals and daily check-ins have completely changed my morning routine. I'm more productive and honestly, just happier.", order: 6 },
...
const FAQS = [
  { question: 'What is SWA?', answer: 'SWA (Where Self Meets Its True Essence) is a holistic mental health and wellbeing company that brings science-backed programs to organizations, institutions, and communities. We blend ancient wisdom with modern psychology to create lasting wellbeing.', order: 0 },
  ...
  { question: 'What kind of wellbeing programs do you offer?', answer: "We offer Wellbeing Festivals, Zen Space design, Employee Happiness Programs, Wellbeing Retreats, Self-Experiential Programs, and 1-on-1 counselling — all customizable to your team.", order: 2 },
  ...
  { question: 'Do you work with remote or hybrid teams?', answer: 'Absolutely. We have robust virtual programs designed for remote and hybrid workforces, ensuring no one is left out of the wellbeing journey regardless of location.', order: 4 },
